...
<div style="float:left; margin-right: 30px">
	<div id="roc2" style="padding: 0 auto;">		
	</div>
	<div id="linegraph">		
	</div>
</div>
...
In the applet to the left, there is a simple 1D classification problem.  Below the ROC are 2 classes of points which are slightly overlapping.  The ROC is drawn by moving the classification threshold from one extreme to the other.  Mousing over the class points, you can see how this is done.
