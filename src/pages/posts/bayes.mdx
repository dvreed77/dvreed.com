...
It can help to try to visualize the probability as large square that can be divided into portions, the probability of hypothesis A happening, $P(\textcolor{#d97706}{A})$ and the probability of A not happening, $P(\textcolor{#059669}{\bar{A}})$. These 2 events are mutually exclusive, and so the entire probability space is covered by these 2 events.
...
$$
P(\textcolor{#d97706}{A}|B) = \frac{P(\textcolor{#d97706}{A})P(B|\textcolor{#d97706}{A})}{P(\textcolor{#d97706}{A})P(B|\textcolor{#d97706}{A}) + P(\textcolor{#059669}{\bar{A}})P(B|\textcolor{#059669}{\bar{A}})}
$$
</div>
