...
It can help to try to visualize the probability as large square that can be divided into 2 main parts, the probability of hypothesis A happening, $P(A)$ and the probability of A not happening, $P(\bar{A})$. These 2 events are mutually exclusive, and so the entire probability space is covered by these 2 events.
