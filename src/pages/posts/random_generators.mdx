...
<DistributionViewer client:load f="f1" />

## Gaussian

<DistributionViewer className="mb-5" f="fGaussian" client:load />
...
<DistributionViewer className="mb-5" f="f2" client:load />
...
<DistributionViewer className="mb-5" f="f3" client:load />

$$
f(x) = x^3 + 0.2
$$

<DistributionViewer className="mb-5" f="f4" client:load />

$$
f(x) = x^2 + (1 - x)^{10}
$$

<DistributionViewer className="mb-5" f="f5" client:load />

---

## Pareto Distribution

<DistributionViewer className="mb-5" f="f6" client:load />
...
<DistributionViewer className="mb-5" f="f7" client:load />

$$
f(x) = 1 + \cos(2\pi x + \pi)
$$

<DistributionViewer className="mb-5" f="f8" client:load />
